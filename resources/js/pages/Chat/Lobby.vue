...
<template>
    ...
    <div
        class="relative min-h-screen overflow-hidden bg-gradient-to-b from-slate-50 via-white to-amber-50"
        style="font-family: 'Space Grotesk', ui-sans-serif, system-ui"
    >
        <div class="pointer-events-none absolute inset-0">
            <div
                class="absolute -right-24 top-10 h-64 w-64 rounded-full bg-amber-200/40 blur-3xl"
            />
            <div
                class="absolute left-10 top-1/2 h-72 w-72 -translate-y-1/2 rounded-full bg-sky-200/50 blur-3xl"
            />
            <div
                class="absolute bottom-10 right-1/4 h-56 w-56 rounded-full bg-rose-200/40 blur-3xl"
            />
        </div>
        ...
        <div class="relative mx-auto flex max-w-5xl flex-col gap-10 p-8">
            ...
            <section class="grid gap-6 md:grid-cols-[1.3fr_1fr]">
                ...
                >
                    <div
                        class="absolute right-6 top-6 h-16 w-16 rounded-2xl bg-amber-100 text-amber-600 shadow-lg"
                    >
                        <div
                            class="flex h-full items-center justify-center text-xl font-bold"
                        >
                            ⊙
                        </div>
                    </div>
                    ...
                    <div
                        class="mt-6 rounded-2xl border border-slate-200/70 bg-white px-5 py-4 shadow-inner"
                    >
                        <p class="text-xs uppercase tracking-widest text-slate-400">
                            userKey
                        </p>
                        <p
                            class="mt-2 break-all text-base font-semibold text-slate-900"
                        >
                            {{ displayUserKey }}
                        </p>
                    </div>
